...
def interpolate(
    ...
    Args:
        ...
        quadrature: (Deprecated) Equivalent to passing a :class:`Quadrature` to `at`. Will be removed in 1.14.
        ...
        domain: (Deprecated) Equivalent to passing a :class:`Domain` to `at`. Will be removed in 1.14.
